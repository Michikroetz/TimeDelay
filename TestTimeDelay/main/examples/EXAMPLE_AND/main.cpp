...
extern "C" void app_main(void)
{
    ...
    */
    ...
    while (true) // Endlos-Schleife
    {
        ...
        bool A = (I1 and I2);
        bool B = (I2 and I3);
        bool C = (I1 and I2 and I3);



        // Ausgaenge setzen
        gpio_set_level(GPIO_Q1, A ); //Verwendung des AND aus der IEC IEC 61131; auch in C++ vorhanden, in C nicht not
        gpio_set_level(GPIO_Q2, B );
        gpio_set_level(GPIO_Q3, C );
        gpio_set_level(GPIO_Q4, I1 );
